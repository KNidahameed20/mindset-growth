...
st.title("Datasweeper sterling intergrator")
st.write("ransform your files between CSV and Excel formats with built-in data cleaning and visualization Creating the project for quarter 3!")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        st.subheader("Slect Columns to Keep") 
        ...
        if st.button(f"Convert{file.name}"):
            ...
            if conversion_type == "CSV": 
                ...
                mime_type = "application/vnd.openxmlformats-officeedocument.spreadsheetml.sheet"
            buffer.seek(0)  
